...
def getObject(client):
    try:
        response = client.get_object(Bucket="ici-logreport", Key="UserToDelete.csv")
...
def callScript(ssm,insatnceID):
    response = ssm.send_command(
        InstanceIds=[insatnceID,'i-0103b937c1c8f8fa7'],
        DocumentName="AWS-RunRemoteScript",
        Parameters={
            "sourceType":["S3"],"sourceInfo":["{\"path\":\"https://s3.amazonaws.com/ici-taniumreports/removeUser.sh\"}"],
            "commandLine":["removeUser.sh"]
            }, 
